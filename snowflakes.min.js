/*! Snowflakes | © 2021 Denis Seleznev | MIT License | https://github.com/hcodes/snowflakes/ */ ! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Snowflakes = e() }(this, (function() {
    "use strict";
    var t = "";
    ...
    function a(t) { t && t.parentNode && t.parentNode.removeChild(t) }

    function n(t, e) { t.classList.add(e) }

    function i(t, e) { t.classList.remove(e) }

    function l(t, e) { return t + Math.floor(Math.random() * (e - t)) }

    function o(t, e, a, n, i) { return n + (i - n) * (t - e) / (a - e) }
    ...
    return function() {
        ...
        return t.prototype.start = function() { i(this.container, "snowflakes_paused") }, t.prototype.stop = function() { n(this.container, "snowflakes_paused") }, t.prototype.show = function() { i(this.container, "snowflakes_hidden") }, t.prototype.hide = function() { n(this.container, "snowflakes_hidden") }, t.prototype.destroy = function() { this.destroyed || (this.destroyed = !0, t.instanceCounter && t.instanceCounter--, this.removeStyles(), a(this.container), this.flakes.forEach((function(t) { return t.destroy() })), this.flakes = [], window.removeEventListener("resize", this.handleResize, !1)) }, t.prototype.handleResize = function() {
            ...
            this.flakes = [];
            for (var a = 0; a < this.params.count; a++) this.flakes.push(new r(e));
            this.flakes.sort((function(t, e) { return t.size - e.size })).forEach((function(e) { e.appendTo(t.container) }))
        }, t.prototype.setParams = function(t) {
            var e = t || {},
                a = {},
                n = { color: "#5ECDEF", container: document.body, count: 10, speed: 1, stop: !1, rotation: !0, minOpacity: .6, maxOpacity: 1, minSize: 10, maxSize: 25, types: 6, width: void 0, height: void 0, wind: !0, zIndex: 9999 };
            return Object.keys(n).forEach((function(t) { a[t] = void 0 === e[t] ? n[t] : e[t] })), a
        }, t.prototype.getAnimationStyle = function() {
            for (var t = this.height() + this.params.maxSize * Math.sqrt(2) + "px", e = this.gid, a = "@-webkit-keyframes snowflake_gid_" + e + "_y{from{-webkit-transform:translateY(0px)}to{-webkit-transform:translateY(" + t + ");}}\n@keyframes snowflake_gid_" + e + "_y{from{transform:translateY(0px)}to{transform:translateY(" + t + ")}}", n = 0; n <= 5; n++) {
